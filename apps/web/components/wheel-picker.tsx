...
import type { WheelPickerProps, WheelPickerValue } from "@ncdai/react-wheel-picker";
import { cn } from "@/lib/utils";

function WheelPickerWrapper({
  className,
  ...props
}: React.ComponentPropsWithoutRef<typeof WheelPickerPrimitive.WheelPickerWrapper>) {
  return (
...
function WheelPicker<T extends WheelPickerValue = string>({
  ...
  return (
    <WheelPickerPrimitive.WheelPicker<T>
      classNames={{
        optionItem: cn(
